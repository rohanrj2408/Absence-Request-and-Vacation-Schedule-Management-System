...
conn = mysql.connector.connect(host="localhost", user="root", password="123456", database="arvs_mock")
cursor=conn.cursor()
...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql://root:123456@localhost/arvs_mock"
db = SQLAlchemy(app)
